...
wherever you want but you will have to modify locations to match your folder structure.  
...
There are 2 switche that you will need to add to the device tree of your devices.  You can put these lines in your device.mk file in your device tree or if your
