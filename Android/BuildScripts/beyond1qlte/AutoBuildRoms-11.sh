...
gnome-terminal -e "bash -c '. /media/pizzag/Android/Roms/AICP/11/Build-beyond1qlte.sh'" </dev/null >/dev/null 2>&1 &
clear
echo ""
...
#gnome-terminal -e "bash -c '. /media/pizzag/Android/Roms/404/11/Build-beyond1qlte.sh'" </dev/null >/dev/null 2>&1 &
#clear
#echo ""
#echo "One Moment, I'm tired & Sleeping for 30 Minutes..."
#echo ""
